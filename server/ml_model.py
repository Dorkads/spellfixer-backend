...
MODEL_PATH = os.path.join(BASE, "ml_artifacts", "model.keras")
TOK_PATH   = os.path.join(BASE, "ml_artifacts", "tokenizer.json")
CORR_PATH  = os.path.join(BASE, "ml_artifacts", "corrections.json")
